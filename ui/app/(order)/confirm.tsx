...
const addresses = [{
  id: 1,
  houseNo: "3343",
  landmark: "raniban party palace",
  mobileNo: "9808224770",
  name: "santosh",
  postalCode: "#23",
  street: "Radhikrishna,mandir"
},

]
const ConfirmationScreen = () => {
  const selectedDistributor = useSelector(state => state.distributor.selectedDistributor);
  const steps = [
  ...
  const handlePlaceOrder = async () => {
    ...
    console.log("Cart before dispatch:", cart);
    ...
    <ScrollView style={{ marginTop: 55 }}>
            ...
            {addresses?.map((item, index) => (
              ...
              >
                {selectedAddress && selectedAddress._id === item?._id ? (
                  <FontAwesome5 name="dot-circle" size={20} color="#8b2ff5" />
                ) : (
                  <Entypo
                    onPress={() => setSelectedAdress(item)}
                    name="circle"
      ...
      {currentStep === 3 && selectedOption === "cash" && (
        <View style={{ marginHorizontal: 20 }}>
          ...
          >
            <Text style={{ fontWeight: 'bold', fontSize: 16, color: 'white' }}>Place your order</Text>
          </Pressable>
        </View>
      )}
    </ScrollView>
